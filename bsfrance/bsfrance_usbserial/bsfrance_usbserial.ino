...
#define MOSI 16 
#define SS 8
#define RST 4 // 8 and 9 are used by altsoftserial
#define DIO0 7 // not used right now?
...
#define BAND 4331E5 //Mhz just to stay away from center band
...
void setup() {
  ...
  SPI.setClockDivider(1); // spi abuse courtesy of the fact that we are running at 1Mhz anyway // SPI_CLOCK_DIV2
...
unsigned long antispam_timestam2 = 0;
...
bool SendSerialIfReady()
{
  ...
  if (readytosen2 and (pseudoseconds > antispam_timestam2))
  {
    ...
    antispam_timestam2 = pseudoseconds + ANTISPAM_TIME_SERIAL;
    return true;
  }
  return false;
}
